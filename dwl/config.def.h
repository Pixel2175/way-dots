...
static uint32_t colors[][3] = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xebdbb2ff, 0x282828ff, 0xa89984ff },
	[SchemeSel]  = { 0x282828ff, 0x83a598ff, 0x458588ff },
	[SchemeUrg]  = { 0xebdbb2ff, 0xcc241dff, 0xfb4934ff },
};
...
/* commands */
static const char *termcmd[] = { "footclient", "-e","tmux",NULL };
